...
export default function LoginPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-stone-50 font-sans px-4">
      ...
      >
        <div>
          <h1 className="font-serif text-xl text-blue-950">Coffre numérique</h1>
          <p className="text-stone-500 text-sm mt-1">Connectez-vous pour accéder aux contacts et documents de la famille.</p>
        </div>
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-md border border-stone-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-800"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2 rounded-md bg-blue-950 text-white text-sm font-medium hover:bg-blue-900 disabled:opacity-60"
        >
